...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_obj1.cpp, i8* null }]
...
define dso_local i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_seh0 to i8*) {
  ...
  %5 = getelementptr inbounds %class.Person, %class.Person* %2, i32 0, i32 0
  store i32 52, i32* %5, align 8
  %6 = getelementptr inbounds %class.Person, %class.Person* %2, i32 0, i32 1
  %7 = invoke nonnull align 8 dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc(%"class.std::__cxx11::basic_string"* nonnull dereferenceable(32) %6, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
          to label %8 unwind label %11

8:                                                ; preds = %0
  invoke void @_ZN6Person5printEv(%class.Person* nonnull dereferenceable(40) %2)
...
define linkonce_odr dso_local void @_ZN6Person5printEv(%class.Person* nonnull dereferenceable(40) %0) #6 comdat align 2 {
  %2 = alloca %class.Person*, align 8
  store %class.Person* %0, %class.Person** %2, align 8
  %3 = load %class.Person*, %class.Person** %2, align 8
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0))
  ...
  %7 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %6, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0))
  %8 = getelementptr inbounds %class.Person, %class.Person* %3, i32 0, i32 0
  %9 = load i32, i32* %8, align 8
  %10 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull dereferenceable(8) %7, i32 %9)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_obj1.cpp() #0 {
